...
public class FindUserController {
	...
	public String login(String username,String password,HttpServletResponse rep,HttpServletRequest req,HttpSession session) throws ServletException, IOException{
